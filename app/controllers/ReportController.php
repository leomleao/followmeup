...
class ReportController extends \HXPHP\System\Controller
	{	
		...
		$this->view->setFile('index')
					->setAssets('css', array(
						            	'public/css/libs/bootstrap-datepicker/datepicker3.css',
								   		...
								   		'public/css/libs/multi-select/multi-select.css',
					...
					->setAssets('js', array(
								   		...
								   		'public/js/libs/multi-select/jquery.multi-select.js',						   		
								   		'public/js/core/reportsScript.js',
								   		// 'public/js/_build/reportsScript.min.js',
